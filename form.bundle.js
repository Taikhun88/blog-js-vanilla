...
.content form .form-btn-container .btn {
  margin-left: 0.5rem;
}`, "",{"version":3,"sources":["webpack://./src/assets/styles/_media-queries.scss","webpack://./src/form/form.scss"],"names":[],"mappings":"AAAA,8BAAA;AAOE,uCAAA;AAOA,6CAAA;AAOA,kBAAA;ACnBF;EACI,aAAA;EACA,uBAAA;EACA,mBAAA;AAGJ;AAFI;EACI,yBAAA;EACA,gBAAA;EACA,WAAA;EACA,aAAA;EACA,6BAAA;EACA,kBAAA;EACA,aAAA;EACA,sBAAA;AAIR;ADhBI;ECIA;IAUQ,eAAA;EAMV;AACF;AALQ;EACI,mBAAA;EACA,aAAA;EACA,sBAAA;AAOZ;AANY;EACI,iBAAA;EACA,oBAAA;EACA,gBAAA;EACA,mBAAA;AAQhB;AANY;EACI,gCAAA;EACA,aAAA;EACA,UAAA;EACA,kBAAA;AAQhB;AAPgB;EACI,2BAAA;AASpB;AANY;EACI,iBAAA;AAQhB;AALQ;EACI,aAAA;EACA,yBAAA;EACA,mBAAA;AAOZ;AANY;EACI,mBAAA;AAQhB","sourcesContent":["/* Landscape phones and down */\n@mixin xs {\n    @media (max-width: 480px) {\n      @content;\n    }\n  }\n  \n  /* Landscape phone to portrait tablet */\n  @mixin sm {\n    @media (max-width: 767px) {\n      @content;\n    }\n  }\n  \n  /* Portrait tablet to landscape and desktop */\n  @mixin md {\n    @media (min-width: 768px) and (max-width: 979px) {\n      @content;\n    }\n  }\n  \n  /* Large desktop */\n  @mixin xl {\n    @media (min-width: 1200px) {\n      @content;\n    }\n  }","@import '../assets/styles/media-queries';\n\n.content {\n    display: flex;\n    justify-content: center;\n    align-items: center;\n    form {\n        background-color: #ffffff;\n        max-width: 700px;\n        width: 100%;\n        padding: 4rem;\n        box-shadow: var(--box-shadow);\n        border-radius: 3px;\n        display: flex;\n        flex-direction: column;\n        @include xs {\n            padding: 0 2rem;\n        }\n        .form-group {\n            margin-bottom: 2rem;\n            display: flex;\n            flex-direction: column;\n            label {\n                font-size: 1.8rem;\n                color: var(--accent);\n                font-weight: 700;\n                margin-bottom: 1rem;\n            }\n            input, textarea {\n                border: 1px solid var(--divider);\n                padding: 1rem;\n                outline: 0;\n                border-radius: 3px;\n                &:focus {\n                    border-color: var(--accent);\n                }\n            }\n            textarea {\n                min-height: 20rem;\n            }\n        }\n        .form-btn-container {\n            display: flex;\n            justify-content: flex-end;\n            align-items: center;\n            .btn {\n                margin-left:0.5rem;\n            }\n        }\n    }\n}"],"sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
/* harmony import */ var _assets_styles_styles_scss__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! ../assets/styles/styles.scss */ "./src/assets/styles/styles.scss");
/* harmony import */ var _form_scss__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! ./form.scss */ "./src/form/form.scss");
/* harmony import */ var _assets_javascripts_modal__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(/*! ../assets/javascripts/modal */ "./src/assets/javascripts/modal.js");
...
initForm();
btnCancel.addEventListener('click', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
  var result;
  return _regeneratorRuntime().wrap(function _callee2$(_context2) {
    while (1) switch (_context2.prev = _context2.next) {
      case 0:
        _context2.next = 2;
        return (0,_assets_javascripts_modal__WEBPACK_IMPORTED_MODULE_26__.openModal)('Si vous quittez la page, vous allez perdre votre article');
      case 2:
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          ...
          formData = new FormData(form); // final version
